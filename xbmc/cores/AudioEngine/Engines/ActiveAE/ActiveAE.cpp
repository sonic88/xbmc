...
void CActiveAE::LoadSettings()
{
  ...
  m_settings.stereoupmix = (m_settings.channels > AE_CH_LAYOUT_2_0 || (m_sink.GetDeviceType(m_settings.device) == AE_DEVTYPE_IEC958)) ? CSettings::Get().GetBool("audiooutput.stereoupmix") : false;
